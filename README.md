...
Current mobile identity: `4.0.0-alpha.4` / versionCode `70` (V4 Stage 4 Cyclone One glass alpha; 3.9.12 workspace + Fast Path + Session Kernel + Skill Compiler retained)
