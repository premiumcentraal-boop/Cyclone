...
if ($bundleMode) {
    $baseDir = $scriptDir
    Note "Detected extracted Cyclone 2.9.5 PC bundle"
} else {
...
$config = @"
# Generated by Cyclone 2.9.5 install-windows.ps1.
...
Write-Host ""
Write-Host "Cyclone 2.9.5 PC components are installed." -ForegroundColor Green
Write-Host "Before starting, set:" -ForegroundColor Yellow
Write-Host '  $env:CYCLONE_ANDROID_BRIDGE_TOKEN = "<Session token shown inside the Cyclone app>"'
