...
const GLASS_VERSION = "1.6.0-alpha.42";
...
test("package.json is Glass 1.6.0-alpha.42", () => {
...
test("Cargo.toml crate version is 1.6.0-alpha.42", () => {
...
test("version.toml keeps Glass and the V5 phone components coherent", () => {
  ...
  assert.match(mobileVersion, /^5\.0\.0-alpha\.42(?:\.dev\d+)?$/);
