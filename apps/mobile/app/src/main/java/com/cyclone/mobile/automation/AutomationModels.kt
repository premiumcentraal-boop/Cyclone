...
enum class StepType { PHONE_TOOL, WAIT, CONDITION, BRANCH, REPEAT, VARIABLE_ASSIGNMENT, PARSE_TEXT, REGEX_EXTRACT, DELAY, ASSERTION, INVOKE_SKILL, STOCK_SKILL, HTTP_REQUEST, SEND_CYCLONE_EVENT, REQUEST_HUMAN_TAKEOVER }
