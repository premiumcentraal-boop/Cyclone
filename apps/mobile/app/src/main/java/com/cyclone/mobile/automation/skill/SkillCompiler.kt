...
class SkillCompiler(
    ...
    fun listDrafts(): List<AutomationDefinition> = store.listAutomations().filter { automation ->
        !automation.enabled && automation.id.startsWith(ID_PREFIX)
    }
    ...
    private fun toDisabledAutomation(capsule: SkillCapsule, existing: AutomationDefinition?): AutomationDefinition {
        ...
        return AutomationDefinition(
            ...
            description = DESCRIPTION_MARKER +
                ...
                " Review in Automations before it can run alone.",
            enabled = false,
