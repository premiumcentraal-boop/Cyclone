...
class VideoStreamController:
    ...
    Cyclone One 0.2.1 prefers JPEG/adb-screenshot for physical focus, matching Mobile 3.9.11
    sampled live-context (~2 fps). scrcpy H.264 is opt-in for tests and is never a provisional
    ``video/avc`` handshake that can time out before a frame exists.
    """
