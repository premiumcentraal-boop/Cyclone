...
INSTRUCTIONS = (
    "Control the phone semantic-first through Cyclone V3 capabilities. Start with status/capability discovery and a compact observation before acting. "
...
TOOLS = [
    _tool("phone_status", "Read Cyclone gateway, ADB, bridge and Accessibility readiness.", {"type": "object", "properties": {}, "additionalProperties": False}, read_only=True),
    _tool("phone_capabilities", "Discover the typed V3 phone capability inventory and health. Discovery is metadata, not action authority.", {"type": "object", "properties": {"refresh": {"type": "boolean", "default": False}}, "additionalProperties": False}, read_only=True),
